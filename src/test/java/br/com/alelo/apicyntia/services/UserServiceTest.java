 ...
 * 
 * import br.com.alelo.apicyntia.entities.User; import
 * br.com.alelo.apicyntia.repositories.UserRepository; import
 * br.com.alelo.apicyntia.services.exceptions.DatabaseException; import
 * br.com.alelo.apicyntia.services.exceptions.ResourceNotFoundException;
 * 
 ...
 * 
 * public User findById(Long id) { Optional<User> obj = repository.findById(id);
 ...
 * 
 * public User update(Long id, User obj) { try { User entity =
 * repository.getOne(id); updateData(entity, obj); return
