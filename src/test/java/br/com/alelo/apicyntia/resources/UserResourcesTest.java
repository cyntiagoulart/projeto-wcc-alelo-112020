...
public class UserResourcesTest {
	 ...
	 * br.com.alelo.apicyntia.services.UserService;
	 * 
	 * @RestController
	 * 
	 * @RequestMapping(value = "/users") public class UserResource {
	 * 
	 ...
	 * findById(@PathVariable Long id) { User obj = service.findById(id); return
	 * ResponseEntity.ok().body(obj); }
	 * 
	 * @PostMapping public ResponseEntity<User> insert(@RequestBody User obj) { obj
	 ...
	 * Long id, @RequestBody User obj) { obj = service.update(id, obj); return
	 * ResponseEntity.ok().body(obj); }
	 * 
	 * 
	 */
